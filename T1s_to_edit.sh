...
# project=HOTEL                                             # HOTEL folder reference
# export HPCDIR=/mnt/hpcdata				                # hpcdata folder reference

export SUBJECTS_DIR=/home/ccd/desktop/T1s_to_edit 	    # **INPUT FOLDER (UNPROCESSED SCANS) HERE**
